...
<body>
  <header>
    ...
    <div class="nav_4_div"><a href="SiteFiles/inc/login.php">Login</a></div>
  </header>
  <div class="content_div">
    <div class="index_content_div">

      <div class="featured_content"><iframe width="100%" height="100%" src="https://poly.google.com/view/9FO4nbdDuQD/embed?chrome=min" frameborder="0" style="border:none;" allowvr="yes" allow="vr; xr; accelerometer; magnetometer; gyroscope; autoplay;" allowfullscreen mozallowfullscreen="true" webkitallowfullscreen="true" onmousewheel="" ></iframe></div>
  ...
  <footer>
    ...
    <div class="secondary_nav_div"><a href="">Admin Login</h5></div>
  </footer>
</body>
</html>
